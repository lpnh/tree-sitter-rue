...
module.exports = grammar({
  ...
  conflicts: $ => [[$._primary_expression, $._type_identifier]],

  rules: {
    source_file: $ => repeat(choice($.struct_item, $.function_item)),
    ...
    field_declaration_list: $ =>
      seq(sepByComma($.field_declaration), optional(',')),
    ...
    parameters: $ => seq('(', optional(sepByComma($.parameter)), ')'),
    ...
    tuple_type: $ =>
      choice(
        seq('(', $._type, ',', ')'),
        seq('(', seq($._type, repeat1(seq(',', $._type)), optional(',')), ')'),
      ),
    ...
    let_statement: $ =>
      seq(
        'let',
        field('name', $.identifier),
        optional(seq(':', field('type', $._type))), // is the type really optional (?)
        '=',
    ...
    field_initializer_list: $ =>
      seq(sepByComma($.field_initializer), optional(',')),
